...
(:objects
  ...
  Roast_pork_with_prunes Spanish_omelette Paella Tuna_steak Chicken_parmesan Lamb_tagine Couscous_meatlof - secondCourse
)
(:init
  ...
  (incompatible Mushroom_risotto Couscous_meatlof)
